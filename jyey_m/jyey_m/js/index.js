    ...
    series: [
        {
            name:'依从率',
            type:'line',
            data:[94.81, 96.15, 96.49, 96.30, 97.15, 96.94,98.32,96.84,95.55,95.92,96.38,96.32,0],
            markLine: {data: [{type: 'average', name: '平均值'}]}
        },
        {
            name:'正确率',
            type:'line',
            data:[96.95, 92.32, 94.95, 95.18, 97.12, 97.49,92.43,93.27,93.62,92.46,94.39,97.71,0],
            markLine: {data: [{type: 'average', name: '平均值'}]}
        }
    ]
}) ;
...
pillar1.setOption({
    ...
    xAxis : [
        {
            type : 'category',
            data : ['2019年9月','2019年10月','2019年11月','2019年12月','2020年1月','2020年2月',
    ...
    series : [
        {
            name:'观察人数',
            type:'bar',
            data:[779, 622, 703, 645, 594, 630, 872, 856, 881, 826, 884, 868,0]
        },
        {
            name:'时机数',
            type:'bar',
            data:[1002, 872, 930, 851, 868, 837, 1096, 1085, 1176, 1087, 1140, 1038,0]
        },
        {
            name:'手卫生次数',
            type:'bar',
            data:[950, 805, 883, 810, 843, 816, 1013, 1012, 1101, 1005, 1076, 952,0]
        }
        ,
        {
            name:'正确数',
            type:'bar',
            data:[921, 774, 852, 780, 819, 791, 996, 980, 1052, 964, 1037, 917,0]
        }
    ]
}) ;
